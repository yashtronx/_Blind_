 ...
 */
public class iTensorFlowObjectDetectionAPIModel implements iClassifier {
  ...
  public static iClassifier create(
    ...
    final iTensorFlowObjectDetectionAPIModel d = new iTensorFlowObjectDetectionAPIModel();
  ...
  private iTensorFlowObjectDetectionAPIModel() {}
