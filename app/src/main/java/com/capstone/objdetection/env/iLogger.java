...
public final class iLogger {
  ...
  static {
    ...
    IGNORED_CLASS_NAMES.add(iLogger.class.getCanonicalName());
  }
  ...
  /**
   * Creates a iLogger using the class name as the message prefix.
   *
   * @param clazz the simple name of this class is used as the message prefix.
   */
  public iLogger(final Class<?> clazz) {
    this(clazz.getSimpleName());
  }

  /**
   * Creates a iLogger using the specified message prefix.
   *
   * @param messagePrefix is prepended to the text of every message.
   */
  public iLogger(final String messagePrefix) {
    this(DEFAULT_TAG, messagePrefix);
  }

  /**
   * Creates a iLogger with a custom tag and a custom message prefix. If the message prefix
   ...
   *                      being used
   */
  public iLogger(final String tag, final String messagePrefix) {
    this.tag = tag;
  ...
  /**
   * Creates a iLogger using the caller's class name as the message prefix.
   */
  public iLogger() {
   ...
   * Creates a iLogger using the caller's class name as the message prefix.
   */
  public iLogger(final int minLogLevel) {
    this(DEFAULT_TAG, null);
  ...
  private static String getCallerSimpleName() {
    ...
    return iLogger.class.getSimpleName();
  }
